...
$('.anasHouse').on('click',function(){
	$('.Pic1').css('background','url(https://upload.wikimedia.org/wikipedia/commons/5/5d/Falguera-bcn-conCent81-2210-01red.jpg)').css('background-size', 'cover');
});
//Listener 2
...
$('.GaudiPark').on('click',function(){
$('.Pic2').css('background','url(https://upload.wikimedia.org/wikipedia/commons/thumb/c/cb/Park_G%C3%BCell_02.jpg/1920px-Park_G%C3%BCell_02.jpg)').css('background-size', 'cover');
});
//listener 3
